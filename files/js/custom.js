...
'<li><a href="https://github.com/mcarver" target="_blank">mcarver</a> (lead contributor) - Marker count, hash permalink improvements, backup/restore settings, numerous fixes etc</li>',
				...
				'<li><a href="https://github.com/msmorgan" target="_blank">msmorgan</a> - Javascript &amp; map data structure improvements</li><br>',
			'<li>Fallout 4 Icon from <a href="sidyseven.deviantart.com/" target="_blank">sidyseven</a></li>',
			'<li>DE Translation: MrxNiceguy</li>',
			'<li>PL Translation: 1teacherr1 </li>',
			'<li>SK Translation: Exosum </li>',
			'<li>BR+ES Translation: <a href="johnhexxusgames.blogspot.com" target="_blank">JohnHexxus</a> </li>',
