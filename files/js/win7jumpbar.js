...
(function( jumplist ) {
	...
	var options = {
		...
		siteName: 'Fallout 4 Map', // Site Name
		applicationName: 'Fallout 4 Map', // Site Name 
		startURL: 'http%3a//fallout4map.de/w', // Homepage URL 
		shortcutIcon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/76608d40ba1c4711b5e79635d8a7089d/Main-favicon.ico', // Main Site Icon
		tooltip: '',

		// Dynamic jumplist tasks & notifications
		rssFeedURL: 'http://www.buildmypinnedsite.com/RSSFeed?feed=https%3a//wiiare.in/feed',
		categoryTitle: 'lifeblog Feed', // Task group name
		defaultTaskIcon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/1580f304d8ef41fbb4fd4eac55f8ade1/GenericTask-favicon.ico', // Generic task icon
		
		navButtonColor: false,
		
		// Jumplist tasks { name: Task Label, action: Task URL, icon: Task Icon }
		staticTasks: [{ name: 'Fallout 4 Map',  action: 'http%3a//fallout4map.de/w', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/bcc9811e79974cd49333a472ab4ad7a6/Task0-favicon.ico', target: 'tab' }],
		
		// Drag and drop site pinning bar		
		prompt: true, // Add a site pinning bar on top of my site pages
		barSiteName: 'Fallout 4 Map' // Site name as it should appear on the pinning bar
	};
